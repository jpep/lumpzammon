...
- **Phase 8.5 — Flow/screens/canvas-default** (split into sub-phases):
  ...
  - **8.5e — Canvas polish** (split):
    ...
    - [ ] **8.5e-3 — Remaining polish.** Online-opponent move animation (needs a state-diff); landscape off-zone refinement; opening-roll dice-tap affordance + animating the opening dice; optional bar-half perspective flip; hit-to-bar fly highlight.
