...
- **Phase 8.5 — Flow/screens/canvas-default** (split into sub-phases):
  ...
  - **8.5e — Canvas polish** (split):
    ...
    - [ ] **8.5e-2 — Remaining polish.** Canvas-native flying-checker/board-fill animation (moves still snap); bear-off **tray** rendering; landscape off-zone refinement; opening-roll dice-tap affordance + animating the opening dice; optional bar-half perspective flip.
