...
- **Phase 8.5 — Flow/screens/canvas-default** (split into sub-phases):
  ...
  - **8.5c — Screens** (split):
    ...
    - [ ] **8.5c-2 — Lobby/menu restyle + theming.** Restyle `LobbyScreen` with GMMN room visuals over the real Firebase lobby; merge `ModeSelect`/`BuildInfo`/About into a GMMN menu; reconcile theming (photo-derived identity; fate of the 4 nick palettes + rainbow easter egg); optional score polyline chart.
