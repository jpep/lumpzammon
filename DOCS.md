...
- **Still pending (Phase 8.4):** drive the canvas from the live engine `GameState` (drag → `moveResolution.js`), port `dice.js`, the animations, the landscape title rotation, and the bear-off tray.
